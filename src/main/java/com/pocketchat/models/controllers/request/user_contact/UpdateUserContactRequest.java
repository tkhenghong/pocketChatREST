...
public class UpdateUserContactRequest {
    ...
    public static UpdateUserContactRequestBuilder builder() {
    ...
    public String toString() {
        return "UpdateUserContactRequest(id=" + this.getId() + ", displayName=" + this.getDisplayName() + ", realName=" + this.getRealName() + ", about=" + this.getAbout() + ", userIds=" + this.getUserIds() + ", userId=" + this.getUserId() + ", mobileNo=" + this.getMobileNo() + ", lastSeenDate=" + this.getLastSeenDate() + ", block=" + this.isBlock() + ", multimediaId=" + this.getMultimediaId() + ")";
    }
    ...
    public static class UpdateUserContactRequestBuilder {
        ...
        public UpdateUserContactRequest.UpdateUserContactRequestBuilder displayName(@NotBlank String displayName) {
            this.displayName = displayName;
            return this;
        }

        public UpdateUserContactRequest.UpdateUserContactRequestBuilder realName(@NotBlank String realName) {
            this.realName = realName;
            return this;
        }

        public UpdateUserContactRequest.UpdateUserContactRequestBuilder about(String about) {
            this.about = about;
            return this;
        }

        public UpdateUserContactRequest.UpdateUserContactRequestBuilder userIds(@Valid @NotEmpty @Size(min = 1) List<String> userIds) {
            this.userIds = userIds;
            return this;
        }

        public UpdateUserContactRequest.UpdateUserContactRequestBuilder userId(String userId) {
            this.userId = userId;
            return this;
        }

        public UpdateUserContactRequest.UpdateUserContactRequestBuilder mobileNo(@NotBlank String mobileNo) {
            this.mobileNo = mobileNo;
            return this;
        }
        ...
        public UpdateUserContactRequest.UpdateUserContactRequestBuilder block(boolean block) {
            this.block = block;
            return this;
        }

        public UpdateUserContactRequest.UpdateUserContactRequestBuilder multimediaId(String multimediaId) {
            this.multimediaId = multimediaId;
            return this;
        }

        public UpdateUserContactRequest build() {
            return new UpdateUserContactRequest(id, displayName, realName, about, userIds, userId, mobileNo, lastSeenDate, block, multimediaId);
        }

        public String toString() {
            return "UpdateUserContactRequest.UpdateUserContactRequestBuilder(id=" + this.id + ", displayName=" + this.displayName + ", realName=" + this.realName + ", about=" + this.about + ", userIds=" + this.userIds + ", userId=" + this.userId + ", mobileNo=" + this.mobileNo + ", lastSeenDate=" + this.lastSeenDate + ", block=" + this.block + ", multimediaId=" + this.multimediaId + ")";
        }
    }
}
