...
public class UpdateChatMessageRequest {
    ...
    public String toString() {
        return "UpdateChatMessageRequest(id=" + this.getId() + ", conversationId=" + this.getConversationId() + ", senderId=" + this.getSenderId() + ", senderName=" + this.getSenderName() + ", senderMobileNo=" + this.getSenderMobileNo() + ", receiverId=" + this.getReceiverId() + ", receiverName=" + this.getReceiverName() + ", receiverMobileNo=" + this.getReceiverMobileNo() + ", type=" + this.getType() + ", status=" + this.getStatus() + ", messageContent=" + this.getMessageContent() + ", multimediaId=" + this.getMultimediaId() + ", createdTime=" + this.getCreatedTime() + ", sentTime=" + this.getSentTime() + ")";
    }
    ...
    public static class UpdateChatMessageRequestBuilder {
        ...
        public UpdateChatMessageRequest.UpdateChatMessageRequestBuilder receiverId(String receiverId) {
            this.receiverId = receiverId;
            return this;
        }

        public UpdateChatMessageRequest.UpdateChatMessageRequestBuilder receiverName(String receiverName) {
            this.receiverName = receiverName;
            return this;
        }

        public UpdateChatMessageRequest.UpdateChatMessageRequestBuilder receiverMobileNo(String receiverMobileNo) {
            this.receiverMobileNo = receiverMobileNo;
            return this;
        }
        ...
        public UpdateChatMessageRequest.UpdateChatMessageRequestBuilder createdTime(@NotNull DateTime createdTime) {
            this.createdTime = createdTime;
            return this;
        }

        public UpdateChatMessageRequest.UpdateChatMessageRequestBuilder sentTime(DateTime sentTime) {
            this.sentTime = sentTime;
            return this;
        }

        public UpdateChatMessageRequest build() {
            return new UpdateChatMessageRequest(id, conversationId, senderId, senderName, senderMobileNo, receiverId, receiverName, receiverMobileNo, type, status, messageContent, multimediaId, createdTime, sentTime);
        }
