...
public class CreateMultimediaRequest {
    ...
    CreateMultimediaRequest(String id, String localFullFileUrl, String localThumbnailUrl, @NotBlank String remoteThumbnailUrl, @NotBlank String remoteFullFileUrl, String messageId, String userContactId, String conversationId, String userId, Integer fileSize) {
        this.id = id;
    ...
    public static CreateMultimediaRequestBuilder builder() {
        return new CreateMultimediaRequestBuilder();
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof CreateMultimediaRequest)) return false;
        final CreateMultimediaRequest other = (CreateMultimediaRequest) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof CreateMultimediaRequest;
    }
    ...
    public static class CreateMultimediaRequestBuilder {
        ...
        CreateMultimediaRequestBuilder() {
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder id(String id) {
            this.id = id;
            return this;
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder localFullFileUrl(String localFullFileUrl) {
            this.localFullFileUrl = localFullFileUrl;
            return this;
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder localThumbnailUrl(String localThumbnailUrl) {
            this.localThumbnailUrl = localThumbnailUrl;
            return this;
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder remoteThumbnailUrl(@NotBlank String remoteThumbnailUrl) {
            this.remoteThumbnailUrl = remoteThumbnailUrl;
            return this;
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder remoteFullFileUrl(@NotBlank String remoteFullFileUrl) {
            this.remoteFullFileUrl = remoteFullFileUrl;
            return this;
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder messageId(String messageId) {
            this.messageId = messageId;
            return this;
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder userContactId(String userContactId) {
            this.userContactId = userContactId;
            return this;
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder conversationId(String conversationId) {
            this.conversationId = conversationId;
            return this;
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder userId(String userId) {
            this.userId = userId;
            return this;
        }

        public CreateMultimediaRequest.CreateMultimediaRequestBuilder fileSize(Integer fileSize) {
            this.fileSize = fileSize;
            return this;
        }

        public CreateMultimediaRequest build() {
            return new CreateMultimediaRequest(id, localFullFileUrl, localThumbnailUrl, remoteThumbnailUrl, remoteFullFileUrl, messageId, userContactId, conversationId, userId, fileSize);
        }

        public String toString() {
            return "CreateMultimediaRequest.CreateMultimediaRequestBuilder(id=" + this.id + ", localFullFileUrl=" + this.localFullFileUrl + ", localThumbnailUrl=" + this.localThumbnailUrl + ", remoteThumbnailUrl=" + this.remoteThumbnailUrl + ", remoteFullFileUrl=" + this.remoteFullFileUrl + ", messageId=" + this.messageId + ", userContactId=" + this.userContactId + ", conversationId=" + this.conversationId + ", userId=" + this.userId + ", fileSize=" + this.fileSize + ")";
        }
    }
}
