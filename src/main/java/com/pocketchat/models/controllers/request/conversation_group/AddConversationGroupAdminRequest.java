...
public class AddConversationGroupAdminRequest {

    @NotEmpty
    @Min(1)
    private List<String> groupMemberIds;

    public AddConversationGroupAdminRequest() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof AddConversationGroupAdminRequest))
            return false;
        final AddConversationGroupAdminRequest other = (AddConversationGroupAdminRequest) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AddConversationGroupAdminRequest;
    }
    ...
    public String toString() {
        return "AddConversationGroupAdminRequest(groupMemberIds=" + this.getGroupMemberIds() + ")";
    }
}
