...
public class MultimediaResponse {
    ...
    MultimediaResponse(String id, String localFullFileUrl, String localThumbnailUrl, String remoteThumbnailUrl, String remoteFullFileUrl, String messageId, String userContactId, String conversationId, String userId, Integer fileSize) {
        this.id = id;
    ...
    public static class MultimediaResponseBuilder {
        ...
        public MultimediaResponse.MultimediaResponseBuilder localFullFileUrl(String localFullFileUrl) {
            this.localFullFileUrl = localFullFileUrl;
            return this;
        }

        public MultimediaResponse.MultimediaResponseBuilder localThumbnailUrl(String localThumbnailUrl) {
            this.localThumbnailUrl = localThumbnailUrl;
            return this;
        }

        public MultimediaResponse.MultimediaResponseBuilder remoteThumbnailUrl(String remoteThumbnailUrl) {
            this.remoteThumbnailUrl = remoteThumbnailUrl;
            return this;
        }

        public MultimediaResponse.MultimediaResponseBuilder remoteFullFileUrl(String remoteFullFileUrl) {
            this.remoteFullFileUrl = remoteFullFileUrl;
            return this;
        }

        public MultimediaResponse.MultimediaResponseBuilder messageId(String messageId) {
            this.messageId = messageId;
            return this;
        }

        public MultimediaResponse.MultimediaResponseBuilder userContactId(String userContactId) {
            this.userContactId = userContactId;
            return this;
        }

        public MultimediaResponse.MultimediaResponseBuilder conversationId(String conversationId) {
            this.conversationId = conversationId;
            return this;
        }

        public MultimediaResponse.MultimediaResponseBuilder userId(String userId) {
            this.userId = userId;
            return this;
        }

        public MultimediaResponse.MultimediaResponseBuilder fileSize(Integer fileSize) {
            this.fileSize = fileSize;
            return this;
        }

        public MultimediaResponse build() {
            return new MultimediaResponse(id, localFullFileUrl, localThumbnailUrl, remoteThumbnailUrl, remoteFullFileUrl, messageId, userContactId, conversationId, userId, fileSize);
        }
