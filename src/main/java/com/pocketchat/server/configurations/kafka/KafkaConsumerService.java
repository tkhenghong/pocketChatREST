...
//    @KafkaListener(topics = "${kafka.topic}") // livetemperature
...
////                kafkaTemplate.send("/topic/temperature", jsonString);
...
//                simpMessagingTemplate.convertAndSend("/topic/temperature", jsonString);
//
//
//
